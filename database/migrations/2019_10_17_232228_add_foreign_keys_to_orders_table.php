...
class AddForeignKeysToOrdersTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('company_id', 'order_company')->references('id')->on('companies')->onUpdate('NO ACTION')->onDelete('CASCADE');
			$table->foreign('location_id', 'order_location')->references('id')->on('locations')->onUpdate('NO ACTION')->onDelete('CASCADE');
	...
	public function down()
	{
		Schema::table('orders', function(Blueprint $table)
		{
			$table->dropForeign('order_company');
