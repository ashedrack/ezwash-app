                                ...
                                <tr>
                                    <td>
                                        <div class="mem-dt" style="text-align: left; padding-bottom: 20px;">
                                            ...
                                            <p>Your Drop off order was received</p>
                                            <p class="indented-txt"> Date: {{ $orderDate }}</p>
                                            <p class="indented-txt"> The code below would be required to pickup your laundry when wash is complete</p>
