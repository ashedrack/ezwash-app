            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" action="{{route('special_discount.save')}}" id="specialOfferCreationForm"
                                  method="post">
                                @csrf
                                @if ($errors->any())
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autocomplete="off" required
                                                       ...
                                                       value="{{ old('start_date') }}" readonly name="start_date"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" autocomplete="off" required
                                                       data-min-date="{{ $minStartDate  }}"
                                                       value="{{ old('end_date') }}" readonly name="end_date"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="customersAutocomplete">Search customer by name or
                                                    email</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered zero-configuration"
                                            ...
                                            <tfoot>
                                            <tr id="emptyCustomer">
                                                <td colspan="5" class="text-center">The customers selected would be
                                                    displayed here
                                                </td>
                                            </tr>
                                            </tfoot>
